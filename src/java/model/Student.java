...
public class Student implements Serializable {
    ...
    public Student(Integer age, String lastname, String location, String name, String subject1, 
    ...
    public String toString() {
        return "id=" + id + ", age=" + age + ", lastname=" + lastname + ", location=" + location 
                + ", name=" + name + ", subject1=" + subject1 + ", subject2=" + subject2 + ", "
